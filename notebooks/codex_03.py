...
def calculate_delay(fr_smooth, bin_centers, config):
    """Compute delay (center of mass) within a responsive window and responsiveness."""
    if fr_smooth is None:
        return np.nan, False
...
def calculate_delays(spikes, clusters, cluster_acronyms, events, config, path_data_processed, pid):
    ...
    for cid in cluster_ids:
        ...
        delay, is_responsive = calculate_delay(fr_smooth, bin_centers, config)
...
def calculate_delay_reliability(
    spikes, clusters, cluster_acronyms, events, config, path_data_processed, pid
):
    ...
    for cid in cluster_ids:
        ...
        _, is_responsive = calculate_delay(fr_all, bins_all, config)
